                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="manageteachers.php">View details</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapsePages" aria-labelledby="headingTwo">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="managestudents.php">View details</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapseStudents" aria-labelledby="headingThree">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="managecategory.php">View details</a>
                            </nav>
                        </div>
