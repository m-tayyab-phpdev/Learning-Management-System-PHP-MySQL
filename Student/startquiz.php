...
$sql_total_questions = "SELECT COUNT(*) as total FROM `quiz_bank` WHERE `quiz_id` = '$var_quiz_id'";
...
if (!isset($_SESSION['current_question'])) {
    ...
    $sqlsave = "INSERT INTO `quiz_answers`(`quiz_id`, `bank_id`, `teacher_id`, `student_id`, `answer`) 
...
$sql_question = "SELECT * FROM `quiz_bank` WHERE `quiz_id` = '$var_quiz_id' LIMIT $current_question_index, 1";
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            ...
                            <div class="question-container" style="background-color: #6a1b9a; padding: 20px; border-radius: 8px; color: white; margin-top: 50px;">
                                <h5><?php echo $question_data['question']; ?></h5>
                            </div>
                            ...
                            <div class="answer-section" style="background-color: white; border-radius: 8px; padding: 20px; margin-top: 20px; border: #0d6efd 1px solid;">
                                <form method="post" action="">
                                    ...
                                    <input type="hidden" name="bankid" value="<?php echo $question_data['bank_id'] ?>">
                                    <div class="row">
