...
if (isset($_POST['btn-register'])) {
    ...
    function EMAIL($var_email, $var_name)
    {
        ...
        $mail->Password   = 'fldc zfza qadz zzbt';
        ...
        $mail->Body    = '<h2>Hello ' . $var_name . '</h2><br> This is account varification email. <br>Click <a href="http://localhost/tayyaba-skillshub/teacher/verify.php?email=' . $var_email . '">Verify account</a> for varification';
