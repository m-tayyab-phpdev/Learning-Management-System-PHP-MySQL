                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="lanchcourse.php">Lanch new course</a>
                                <a class="nav-link" href="coursedetails.php">Course details</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapsePages" aria-labelledby="headingTwo">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="assignmentresult.php">Assignments</a>
                                <a class="nav-link" href="quizresult.php">Quizzes</a>
                                <a class="nav-link" href="examresult.php">Exams</a>
                            </nav>
                        </div>
